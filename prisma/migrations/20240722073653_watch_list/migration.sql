/*
  ...
  - You are about to drop the `stock_on_groups` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "stock_on_groups" DROP CONSTRAINT "stock_on_groups_groupId_fkey";

-- DropForeignKey
ALTER TABLE "stock_on_groups" DROP CONSTRAINT "stock_on_groups_stockSymbol_fkey";
