...
-- CreateTable
CREATE TABLE "stock_on_groups" (
    "stockSymbol" TEXT NOT NULL,
    "groupId" INTEGER NOT NULL,

    CONSTRAINT "stock_on_groups_pkey" PRIMARY KEY ("stockSymbol","groupId")
);
...
-- AddForeignKey
ALTER TABLE "stock_on_groups" ADD CONSTRAINT "stock_on_groups_stockSymbol_fkey" FOREIGN KEY ("stockSymbol") REFERENCES "stocks"("symbol") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stock_on_groups" ADD CONSTRAINT "stock_on_groups_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "groups"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
